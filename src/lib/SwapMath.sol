...
library SwapMath {
        ...
        )
    {
        ...
        amountIn = zeroForOne
            ? MathAmount.calcAmount0Delta(
                sqrtPriceCurrentX96,
                sqrtPriceTargetX96,
                liquidity,
                true
            )
            : MathAmount.calcAmount1Delta(
                sqrtPriceCurrentX96,
                sqrtPriceTargetX96,
                liquidity,
                true
        ...
        if (amountRemainingLessFee >= amountIn)
            ...
            sqrtPriceNextX96 = MathAmount.getNextSqrtPriceFromInput(
                sqrtPriceCurrentX96,
                liquidity,
        ...
        if (zeroForOne) {
            ...
            amountOut = MathAmount.calcAmount1Delta(
                sqrtPriceCurrentX96,
                sqrtPriceNextX96,
                liquidity,
                false
            ...
            amountOut = MathAmount.calcAmount0Delta(
                sqrtPriceCurrentX96,
                sqrtPriceNextX96,
                liquidity,
                false
        ...
        if (!max) {
            ...
            feeAmount = MathAmount.mulDivRoundingUp(amountIn, fee, 1e6 - fee);
        }
    }
}
